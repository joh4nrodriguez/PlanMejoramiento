...
public class Media {
    ...
    public interface DownloadListener{
        void onMediaDownload(String content); // Metodos que la interfaz va a implementar 
    }
    public void dowload(DownloadListener downloadListener){
        Thread thread = new Thread (new Runnable () { // Thread-Hilo
            @Override // Esto se ejecuta una vez haya finalizado de descargar la pelicula
            public void run() {
            ...
            content = "Un tipo le matan su perrito y va y mata a todos";
