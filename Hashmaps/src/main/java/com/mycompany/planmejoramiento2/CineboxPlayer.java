...
public class CineboxPlayer  implements MediaDownloader.DownloadListener{ // Implementar la interfaz
    ...
    public void initialize(){
        ...
        HashMap<Integer, Media> mediaHashmap = new HashMap<>(); // Mpa para guardar y tomar datos de el mismo. Se pueden utilizar cualquier tipo de dato
        mediaHashmap.put(1,umbrella); // Las llaves no se pueden repetir
        mediaHashmap.put(2,Walkind);
        mediaHashmap.put(3,Pedro);
        
        Media media = mediaHashmap.get(2);
        System.out.println(media.getTitulo());
        
        /**PriorityQueue <Media> mediaQueue = new PriorityQueue<>();// Añadir una cola
        mediaQueue.add(umbrella); 
        mediaQueue.add(Walkind); 
        mediaQueue.add(Pedro); 
